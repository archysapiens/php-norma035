...
<style>
				...
				@media(min-width: 990px) {
					...
					background-image: linear-gradient(rgb(212,193,156),rgb(135,108,71) ) !important; 
			...
			<table align="center">
			  <tbody><tr>
				 <td width="420" align="left">
				 	<!--
				 	<img src="http://www.ran.salud.gob.mx/images/logoSALUD_hoz.png" width="289" height="95">
-->
				 </td>
					...
					<section id="formHolder" class="hidden-xs hidden-sm">
						<div class="row">
							...
							<div class="col-sm-6 brand">
								...
								<div class="heading">
									<img src="./images/otro.png" id="logo-Secretaria-Salud" width="336px" height="128px"/>
								</div>
				...
				<div id="footerEPN" style="clear:both; margin-top: 12px;">
					...
					<div style="margin: 32px auto 42px auto; text-align: center; font-family: 'Times New Roman', serif; font-weight: lighter; font-size: 14px;">
					  <p style="color: #808080; line-height: 5px;">Marina Nacional No. 60, Colonia Tacuba, Delegacion Miguel Hidalgo  - Tel. (55) 50-62-16-00 y (55) 50-62-17-00</p>
