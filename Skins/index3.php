...
<html lang="en">
	<head>
		...
		<title>Administración de Personal SSA</title>
...
<style>
				...
				@media(min-width: 990px) {
					...
					.form .form-peice {
					  background: url(images/trian10.png);
					...
					<section id="formHolder" class="hidden-xs hidden-sm">
						<div class="row">
							...
							<div class="col-sm-6 brand">
								...
								<div class="heading">
									<img src="images/SALUD_VERTICAL_BLAN.png" id="logo-4-trasformacion" width="298px" height="235px"/>
								</div>
