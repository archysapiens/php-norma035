...
<style>
				#body2{	
					background-image: linear-gradient(to bottom, rgba(212, 207, 207, 0.33) 0%,rgba(195, 188, 188, 0.22) 100%), 
					url("saludLogo.jpg");
					width:1350px;
					height:700px;
					opacity:0.1;
			...
			<table align="center">
			  <tbody><tr>
				 ...
				 <td width="683" align="right">
						 <div class="col-lg-12">
								<h2>Inovación en Infraestructura</h2>
					</div>
				 </td>    
			  </tr>
			</tbody></table>
					...
					<section id="formHolder" class="hidden-xs hidden-sm">
						<div class="row">
							...
							<div class="col-sm-6 brand">
								<a href="#" class="logo">Sistema de Gestión Empresarial IVISA <span></span></a>
								<div class="heading">
									<img src="../images/ivisa_logo1.PNG" id="logo-ecosheys" width="289px" height="170px"/>
								</div>
