...
$('#btn-aprobar').click(function(){
           ...
           console.log('a ref >>'+ IdARef +'<<');
           	...
           	$.confirm({
                ...
                content: 'url:movi_spc_aprobar.php',
                columnClass: 'medium',
                animationSpeed:800,
                animationBounce:1,
                animation: 'zoom',
...
$('#btn-comentar').click(function(){
           ...
           console.log('a ref >>'+ IdARef +'<<');
           	...
           	$.confirm({
                icon: 'fa fa-check-circle fa-2x',
                title: 'Sistema de Movimientos de Personal',
                content: 'url:movi_spc_comentario.php',
                columnClass: 'medium',
                animationSpeed:800,
                animationBounce:1,
                animation: 'zoom',
...
$('#btn-cancelar').click(function(){
           ...
           console.log('a ref >>'+ IdARef +'<<');
           	...
           	$.confirm({
                icon: 'fa fa-check-circle fa-2x',
                title: 'Sistema de Movimientos de Personal',
                content: 'url:movi_spc_cancelar.php',
                columnClass: 'medium',
                animationSpeed:800,
                animationBounce:1,
                animation: 'zoom',
...
<label id=\"switch-cl\">
					...
					<div class=\"profile-user-info\">
							...
							<div class=\"col-xs-2\">
										<a id=\"btn-aprobar\" href=\"#\" class=\"btn btn-app btn-success enabled\">
...
$('a').click(function(){
           ...
           if(Demo.test(IdARef)){
           	...
           	$.confirm({
                ...
                title: 'Sistema de Movimientos de Personal',
                content: 'url:movi_demo_cedula.html',
                columnClass: 'medium',
                animationSpeed:800,
                animationBounce:1,
                animation: 'zoom',
