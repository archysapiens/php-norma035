...
if(isset($_POST['formCreatedNewOrdenT'])){
		$Extintores->saveOrdenDeTrabajo($_POST);
	}else if(isset($_POST['GererateJsonOT'])){
		$Extintores->gerateJsonOT($_POST);}
	else if(isset($_POST['formAddEmailEnvio'])){
		$Extintores->saveAddEmailCorreoEnvio($_POST);}
	else if(isset($_POST['folioDeleteTable'])){
		$Extintores->deleteTableNewOrdenT($_POST);}
	else if(isset($_POST['formUpdatedOrdenT'])){
		$Extintores->updateOrdenTraTecnico($_POST);}
	else{
 ?>
			<!DOCTYPE html>
			<html lang="en">
				...
				<body> <?php
					...
					view('Extintores/newExtintores',$variables); 
					include("../login/control_session.php"); ?>
						...
						<script>
							...
							window.addEventListener("load", function() {
							  frm_Extintores.txtnoCliente.addEventListener("keypress", soloNumeros, false);
							});
