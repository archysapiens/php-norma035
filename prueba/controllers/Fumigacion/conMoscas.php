...
if(isset($_POST['formCreatedReportMoscas'])){
		$Fumigacion->saveReporMoscas($_POST);
	}else if(isset($_POST['GererateJson'])){
		$Fumigacion->gerateJsonReport($_POST);}
	else if(isset($_POST['formUpdatedReportMoscas'])){
		$Fumigacion->updateReporMoscasTecnico($_POST);}
 ...
 ?>
			...
			<html lang="en">
				...
				$breadcrumbPrincipal='Reporte de Consumo de Moscas';
				...
				view('Fumigacion/consuMoscas',$variables);  
