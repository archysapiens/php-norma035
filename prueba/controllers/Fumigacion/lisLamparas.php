...
if(isset($_POST['formCreatedReportInpecLamp'])){
		$Fumigacion->saveReportInpecLamp($_POST);
	}else if(isset($_POST['GererateJsonRL'])){
		$Fumigacion->gerateJsonReportRL($_POST);}
	else if(isset($_POST['formUpdatedReportInpecLamp'])){
		$Fumigacion->updateReporInpecLampTecnico($_POST);}	
 ...
 ?>
			...
			<html lang="en">
				...
				$breadcrumbPrincipal='Reporte de Inspección de Lámparas';
				...
				view('Fumigacion/listadoLamparas',$variables);  
