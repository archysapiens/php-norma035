...
require_once 'fpdi.php';
	...
	$fileJson = '../../repositorio/DataJson/DataFumigacion/ReportesMoscas/'.$sucursal.'/dataReport'.$noCliente.'.json';
	$str_datos = json_decode(file_get_contents("$fileJson"),true);
	
$pdf = new FPDI();
$pageCount = $pdf->setSourceFile("ReporteMoscasActual.pdf");
...
{	
	...
	$pdf->Cell(32.85,5.5,"$ubicacion",1,1,'L');  //UBICACION 1	
	$pdf->SetXY(67.70,  $y);
...
$nombre_fichero = '../../web/UploadPdf/PdfFumigacion/ReportesMoscas/'.$sucursal.'';

if (file_exists($nombre_fichero)) {
	$pdf->Output('F',"../../web/UploadPdf/PdfFumigacion/ReportesMoscas/$sucursal/$noFolio-$noCliente.pdf",'UTF-8 (true)');
}else {
