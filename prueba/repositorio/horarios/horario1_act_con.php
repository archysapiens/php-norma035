     ...
     <div class="row">
          <label  class="control-label col-xs-3">Hor. Atenci&oacute;n 1:</label>
          <div class="col-xs-4">
               <select  id="hora1_act_con" name="hora1_act_con" class="form-control hora1_act_con" >
          ...
          <div class="col-xs-4">
               <select  id="hora2_act_con" name="hora2_act_con" class="form-control hora2_act_con">
                    <option value="">SELECCIONE</option>
                    <option value="12:00AM">12:00AM</option>
                    <option value="12:30AM">12:30AM</option>
                    <option value="01:00AM">01:00AM</option>
