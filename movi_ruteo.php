...
elseif( $method == "GET") {
	...
	$_SESSION['ur'] 	= "513";
	$_SESSION['urd'] 	= "Direccion General de Recursos Humanos";
	$_SESSION['nombre'] = "Noe ALvarez Salvador";
	...
	if(!$res)
		...
		if ($Usuario == "ur@salud.gob.mx")	{
			...
			$Email = "ur@salud.gob.mx"; //$key['EMAIL'];
			$Nombre = "Noe Alvarez Salvador"; //$key['NOMBRE'];
			$UR =513 ; //$key['UR'];
			$URDesc ="DGRHO"; //"$key['DESCRIPCION_UR'];
			$IDRol =4; //$key['ID'];
			$RolDesc ="Administrador"; //$key['DESCRIPCION'];
