...
<style>
				#body2{	
					background-image: linear-gradient(to bottom, rgba(179,142,93 , 0.33) 0%,rgba(179,142,93, 0.22) 100%), url("saludLogo.jpg");
					width:1350px;
					height:700px;
					opacity:0.1;
					position:absolute;
				...
				@media(min-width: 990px) {
					...
					background-image: linear-gradient(rgba(212,193,156,.02),rgba(135,108,71,1) ) !important; 
			...
			<table align="center">
			  <tbody><tr>
				 <td width="420" align="left">
				 	...
				 	<img src="images/stps.png" width="320" height="93">
					...
					<section id="formHolder" class="hidden-xs hidden-sm">
						<div class="row">
							...
							<div class="col-sm-6 brand">
								...
								<div class="heading">
									<img src="./images/GOB_Logo_Pro_VinoA.jpg" id="logo-Secretaria-Salud" width="439px" height="399px"/>
								</div>
				...
				<div id="footerEPN" style="clear:both; margin-top: 12px;">
					...
					<div style="color: #d4c19c; border-top: 1px solid #dedede; border-bottom: 1px solid #dedede; font-family: 'Times New Roman', serif; font-size: 14px; color: #d4c19c; text-align: center; padding: 14px 0px;">
					SECRETARÍA DEL TRABAJO Y PREVISION SOCIAL </div>
					...
					<div style="margin: 32px auto 42px auto; text-align: center; font-family: 'Times New Roman', serif; font-weight: lighter; font-size: 14px;">
					  <p style="color: #d4c19c; line-height: 5px;">Av. BENITO JUAREZ GARCIA No. 802, Colonia San Pedro, Municipio San Mateo Atenco  - Tel. (55) 722.22.45-131</p>
					  <p style="color: #d4c19c; line-height: 5px;">Ciudad de México CP. 11410</p>
					</div>
